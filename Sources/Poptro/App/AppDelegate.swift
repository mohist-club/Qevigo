...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        NotificationCenter.default.addObserver(forName: .poptroShortcutRecording, object: nil, queue: .main) { [weak self] note in
    ...
    private func rebuildMenus() {
        ...
        statusMenu.addItem(.separator())
        statusMenu.addItem(item(tr("退出 Poptro", "Quit Poptro"), #selector(NSApplication.terminate(_:)), key: "q", target: NSApp))
        ...
        appMenu.addItem(item(tr("退出 Poptro", "Quit Poptro"), #selector(NSApplication.terminate(_:)), key: "q", target: NSApp))
        main.addItem(submenu(appMenu, title: "Poptro"))
