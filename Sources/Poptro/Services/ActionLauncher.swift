...
enum ActionLauncher {
    ...
    private static func executeSystem(_ action: SystemShortcutAction, displayName: String) {
        ...
        if let info {
            present(NSError(domain: "Poptro.SystemAction", code: info[NSAppleScript.errorNumber] as? Int ?? 1, userInfo: [
            ...
            DispatchQueue.global(qos: .userInitiated).async {
                ...
                do {
                    ...
                    if process.terminationStatus == 0 {
                        ...
                        continuation.resume(throwing: NSError(domain: "Poptro.Action", code: Int(process.terminationStatus), userInfo: [
