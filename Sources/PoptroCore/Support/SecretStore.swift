...
public final class EncryptedFileSecretStore: SecretStoring, @unchecked Sendable {
    ...
    static func encrypt(_ value: String) -> String? {
        guard let sealed = try? AES.GCM.seal(Data(value.utf8), using: key(salt: "poptro.v2")),
              let combined = sealed.combined else { return nil }
        return "v2:" + combined.base64EncodedString()
    }

    static func decrypt(_ value: String, salt: String = "poptro.v2", prefix: String = "v2:") -> String? {
